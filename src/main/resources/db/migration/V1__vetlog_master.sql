...
CREATE TABLE `pet` (
  ...
  KEY `FK87x36k4uwowulincp57w6vv7` (`pet_adoption_id`),
  KEY `FKiqbjbaml7gtwulqptktmsi5dc` (`breed_id`),
  KEY `FK9hxka0oqkd15dmqstdarori08` (`user_id`),
  CONSTRAINT `FK87x36k4uwowulincp57w6vv7` FOREIGN KEY (`pet_adoption_id`) REFERENCES `pet_adoption` (`id`),
...
-- Dump completed on 2017-06-04 10:51:42
