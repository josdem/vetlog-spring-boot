 ...
 */
 ...
 import com.josdem.vetlog.model.Vaccination; // Import the Vaccination model
 ...
 public class PetController {
     ...
     public ModelAndView viewVaccinations(@PathVariable("uuid") String uuid) {
         log.info("Viewing vaccinations for pet: {}", uuid);
         ModelAndView modelAndView = new ModelAndView("pet/vaccinations");
         Pet pet = petService.getPetByUuid(uuid);
         List<Vaccination> vaccinations = vaccinationService.getVaccinationsByPet(pet);
         modelAndView.addObject("pet", pet);
         modelAndView.addObject("vaccinations", vaccinations);
         return modelAndView;
     }
 
     // Method to update vaccination status
     @PostMapping(value = "/vaccination/update")
     public ModelAndView updateVaccinationStatus(@RequestParam("vaccinationId") Long vaccinationId,
                                                 @RequestParam("status") String status,
                                                 HttpServletRequest request) {
         log.info("Updating vaccination status: {} for id: {}", status, vaccinationId);
         vaccinationService.updateVaccinationStatus(vaccinationId, status);
         ModelAndView modelAndView = new ModelAndView("redirect:/pet/vaccinations/" + vaccinationId);
         modelAndView.addObject("message", localeService.getMessage("vaccination.updated", request));
         return modelAndView;
     }
 }
