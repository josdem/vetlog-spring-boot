...
public class PetController {
    ...
    public ModelAndView update(@Valid PetCommand petCommand, BindingResult bindingResult, HttpServletRequest request) throws IOException {
    ...
    public ModelAndView save(@Valid PetCommand petCommand, BindingResult bindingResult, HttpServletRequest request) throws IOException {
