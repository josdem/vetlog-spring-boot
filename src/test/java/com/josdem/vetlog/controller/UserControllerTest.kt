...
class UserControllerTest {
    ...
    @Test
    @Transactional
    fun `should registering an user`(testInfo: TestInfo) {
    ...
    @Test
    fun `should not save user with invalid email`(testInfo: TestInfo) {
        log.info(testInfo.displayName)
        val request =
            post("/user/save")
                .with(csrf())
    ...
    @Test
    fun `should not save user with invalid mobile`(testInfo: TestInfo) {
        log.info(testInfo.displayName)
        val request =
            post("/user/save")
                .with(csrf())
